...
// your @apollo/client version. This file is not meant to be imported.
{
  ...
  6: {
    file: "@apollo/client/cache/inmemory/readFromStore.js",
    node: invariant(fragment = fragmentMap[selection.name.value], "No fragment named " + selection.name.value)
  },
  ...
  12: {
    ...
    node: new InvariantError('cache-only fetchPolicy option should not be used together with query refetch.')
  },
